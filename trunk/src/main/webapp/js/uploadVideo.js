        ...
        this.each(function () {
            ...
            function addItem(_this) {
                if (ops.imgWidth) {
                    ...
                    _this.append('<label class="up-add up-plus"><img src="" alt=""><input class="up-file" type="file" accept="image/*"><span class="up-del"></span></label>');
                    if(type==2)
                    _this.append('<label class="up-add up-plus"><img src="" alt=""><input class="up-file" type="file" accept="video/*"><span class="up-del"></span></label>');
                }
            }
                ...
                FileAPI.upload({
                    ...
                    complete: function (err, xhr) {
                        ...
                        if (result.code === 0) {
                            ...
                            var labels = _this.find("label");
                            if (_this.find("label").length < ops.addLen&&$(labels.last()).hasClass("up-succeed")&&type==1) {
                                addItem(_this);
                            }
                        }
                        if (result.code === -1) {
                            oImg.addClass("up-plus");
                            oImg.removeClass("up-succeed");
